...
namespace StockTracker.MangoScraper.Consumers;

public class CheckStockCommandConsumer : IConsumer<CheckStockCommand>
{
    private readonly IMangoStockCheckService _checkService;
    private readonly ILogger<CheckStockCommandConsumer> _logger;

    public CheckStockCommandConsumer(IMangoStockCheckService checkService, ILogger<CheckStockCommandConsumer> logger)
    {
