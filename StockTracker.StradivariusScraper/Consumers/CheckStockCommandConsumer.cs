...
namespace StockTracker.StradivariusScraper.Consumers;

public class CheckStockCommandConsumer : IConsumer<CheckStockCommand>
{
    private readonly IStradivariusStockCheckService _checkService;
    private readonly ILogger<CheckStockCommandConsumer> _logger;

    public CheckStockCommandConsumer(IStradivariusStockCheckService checkService, ILogger<CheckStockCommandConsumer> logger)
    {
