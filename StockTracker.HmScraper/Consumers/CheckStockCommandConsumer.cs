...
namespace StockTracker.HmScraper.Consumers;

public class CheckStockCommandConsumer : IConsumer<CheckStockCommand>
{
    private readonly IHmStockCheckService _checkService;
    private readonly ILogger<CheckStockCommandConsumer> _logger;

    public CheckStockCommandConsumer(IHmStockCheckService checkService, ILogger<CheckStockCommandConsumer> logger)
    {
