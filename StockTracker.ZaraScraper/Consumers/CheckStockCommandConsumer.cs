...
namespace StockTracker.ZaraScraper.Consumers;

public class CheckStockCommandConsumer : IConsumer<CheckStockCommand>
{
    private readonly IZaraStockCheckService _checkService;
    private readonly ILogger<CheckStockCommandConsumer> _logger;

    public CheckStockCommandConsumer(IZaraStockCheckService checkService, ILogger<CheckStockCommandConsumer> logger)
    {
