...
namespace StockTracker.BeymenScraper.Consumers;

public class CheckStockCommandConsumer : IConsumer<CheckStockCommand>
{
    private readonly IBeymenStockCheckService _checkService;
    private readonly ILogger<CheckStockCommandConsumer> _logger;

    public CheckStockCommandConsumer(IBeymenStockCheckService checkService, ILogger<CheckStockCommandConsumer> logger)
    {
